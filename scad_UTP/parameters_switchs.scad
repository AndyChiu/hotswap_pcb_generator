...
ks_mx=      [[15.6 ,15.6,11.6 ],[ 7   ,5.1, 3.6 ]];
ks_choc=    [[15   ,15.0, 5   ],[10.2 ,4.5, 3   ]];
ks_chocV2=  [[15   ,15.0, 5.3 ],[6.5  ,6.5, 3.1 ]];
ks_chocMini=[[14.5 ,13.5, 3.2 ],[9.7  ,4.2, 2.65 ]];
ks_ks27=    [[15   ,15  , 5.85],[9.5  ,6.5, 2.75 ]];
ks_ks33v3=  [[15   ,15  , 5.85],[10   ,4  , 2.75 ]];
ks_mx_low=  [[15   ,15  , 5   ],[6.5  ,6.5, 3.6 ]];
ks_romer_g= [[15.4 ,15.4,10.7 ],[11.9 ,9.9, 3.8 ]];
ks_redragon_low=[[15,15 ,5.6  ],[7    ,5.1, 3.1 ]];
ks_alps=    [[16.6 ,13.8,11.7 ],[7.8  ,4.5, 4.3 ]];
