...
module case_shell(height, switch_layout, mcu_layout, ec11_layout, evqwgd001_layout, trrs_layout, plate_layout, stab_layout) {
...
module case(switch_layout, mcu_layout, ec11_layout, evqwgd001_layout, trrs_layout, plate_layout, stab_layout, standoff_layout) {
    ...
    intersection() {
        ...
        translate([0,0,-height+plate_thickness/2])
            case_shell(height, switch_layout, mcu_layout, ec11_layout, evqwgd001_layout,trrs_layout, plate_layout, stab_layout);
        difference() {
            union() {
...
//difference() {
    ...
    case(switch_layout_final, mcu_layout_final, ec11_layout_final, evqwgd001_layout_final,trrs_layout_final, plate_layout_final, stab_layout_final, standoff_layout_final);

    union()
        {

    translate([-30, -200, -15]) 
        rotate ([0,0,-30]) cube([100,80,20]);
    
    translate([15, -143, -15]) 
        rotate ([0,0,-65]) cube([30,30,20]);
