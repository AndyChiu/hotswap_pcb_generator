...
/* kle_filename: willow-3x6+esrille-thumb-3x1-(v2)-r.json 
...
base_switch_layout = [
  [//Fn6
[[0.0353,5.4549],[1,1],[43.16,0.5353,5.9549]],[0,0,0,0],[false,switch_type,["RU",7,7,0,1,h_unit+2,v_unit,"R"],"Fn6"]],
  [//Fn5
[[0.8951,4.7845],[1,1],[32.31,1.3951,5.2845]],[0,0,0,0],[false,switch_type,["RU",10,10,1.5,1,h_unit+6,v_unit,"C"],"Fn5"]],
  [//Fn4
[[1.8736,4.2937],[1,1],[21.41,2.3736,4.7937]],[0,0,0,0],[false,switch_type,["RU",15,15,5,1,h_unit+2,v_unit,"L"],"Fn4"]],

  [//Y
[[0.6954,1.3325],[1,1],[6,1.1954,1.8325]],[0,0,0,0],[false,switch_type,["LU",10+5,10+5,6,1,h_unit+2,v_unit+2,"RD"],"Y"]],
  [//H
[[0.865,2.3824],[1,1],[13.5,1.365,2.8824]],[0,0,0,0],[false,switch_type,["L",0,10+5,6,1,h_unit+2,v_unit+4.5,"R"],"H"]],
  [//N
[[1.1626,3.4066],[1,1],[20.6,1.6626,3.9066]],[0,0,0,0],[false,switch_type,["LD",5+5,10+5,6,1,h_unit+2,v_unit+2,"RU"],"N"]],

  [//U
[[1.6707,0.93049],[1,1],[5.1,2.1707,1.4304]],[0,0,0,0],[false,switch_type,["LU",9+5,9,2,1,h_unit+4,v_unit+2.0,"D"],"U"]],
  [//J
[[1.8224,1.974],[1,1],[11.5,2.3224,2.474]],[0,0,0,0],[false,switch_type,["L",0,9,2,1,h_unit+4,v_unit+4.5,"C"],"J"]],
  [//M
[[2.097,2.9997],[1,1],[19,2.597,3.4997]],[0,0,0,0],[false,switch_type,["LD",5+5,9,2,1,h_unit+4,v_unit+2.0,"U"],"M"]],

  [//I
[[2.6602,0.5],[1,1],[4.5,3.1602,1]],[0,0,0,0],[false,switch_type,["LU",8+5,8,1,1,h_unit+4,v_unit+2.0,"D"],"I"]],
  [//K
[[2.7689,1.5378],[1,1],[9.9,3.2689,2.0378]],[0,0,0,0],[false,switch_type,["L",0,8,1,1,h_unit+4,v_unit+4.9,"C"],"K"]],
  [//,
[[3.0209,2.5756],[1,1],[18.1,3.5209,3.0756]],[0,0,0,0],[false,switch_type,["LD",5+5,8,1,1,h_unit+4,v_unit+2.0,"U"],","]],

  [//O
[[3.6802,0.7199],[1,1],[5.9,4.1802,1.2199]],[0,0,0,0],[false,switch_type,["LU",9+6,7,0.5,1,h_unit+3.5,v_unit+2.0,"D"],"O"]],
  [//L
[[3.8524,1.7688],[1,1],[13.2,4.3524,2.2688]],[0,0,0,0],[false,switch_type,["L",0,7,0.5,1,h_unit+3.5,v_unit+4.9,"C"],"L"]],
  [//.
[[4.1736,2.7898],[1,1],[21.5,4.6736,3.2898]],[0,0,0,0],[false,switch_type,["LD",5+6,7,0.5,1,h_unit+3.5,v_unit+2.0,"U"],"."]],

  [//P
[[4.7857,1.1872],[1,1],[10,5.2857,1.6872]],[0,0,0,0],[false,switch_type,["LU",10+7,6,0,1,h_unit+2,v_unit+2.5,"LD"],"P"]],
  [//;
[[5.0569,2.2281],[1,1],[19,5.5569,2.7281]],[0,0,0,0],[false,switch_type,["L",0,6,0,1,h_unit+2,v_unit+4.5,"L"],";"]],
  [///
[[5.4657,3.1972],[1,1],[24.9,5.9657,3.6972]],[0,0,0,0],[false,switch_type,["LD",5+7,6,0,1,h_unit+2,v_unit+2.0,"LU"],"/"]],
];

// MCU Position(s)
base_mcu_layout = [
[[[-1,2],mcu_h_unit_size,[10,-1,2]],[1,1,1,1]],
];
...
*/
[[48.32-5,-9.96-2,-2],[10.5,1],"Coral","1"],
[[104.5,-18.5,-2],[10.5,1],"Coral","2"],
[[117.9-2,-72.7,-2],[10.5,1],"Coral","3"],
[[64.18,-65.28,-2],[10.5,1],"Coral","4"],
[[55.43+2,-89.51+1,-2],[10.5,1],"Coral","5"],
[[0.71,-111.2,-2],[10.5,1],"Coral","6"],
//[[-14.92-2,-33.4-1,-2],[10.5,1],"Coral","7"],
[[-6,-48.6,-2],[10.5,1],"Coral","7"],
//[[-2.45+0.5,-48.8+2,-2],[10.5,1],"Coral","8"],
[[13.9,-59,-2],[10.5,1],"Coral","8"],
];
...
*/
[[80, -72, -1],[0,0,-11],1.5,["Designed by Andy Chiu","Bauhaus 93",2],"Blue"],
];
...
/* Write recessed text content on the PCB board / 在PCB板上寫上內凹文字內容   
    ...
    =[[x, y, z],[r_x, r_y, r_z],LE_size,[text,font,size],"Show Color"]
*/
[[87 , -15+1, -0.5],[0,0,-11],0.6,["W36 V2","Bauhaus 93",3],"Blue"],
[[87 , -15-4.3+1.5, -0.5],[0,0,-11],0.6,["Curve","Bauhaus 93",3],"Blue"],
];
