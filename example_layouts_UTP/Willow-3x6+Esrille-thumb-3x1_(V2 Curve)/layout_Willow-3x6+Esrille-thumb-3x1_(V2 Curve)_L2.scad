...
base_switch_layout = [
  [//Q 
[[0.6799,1.1872],[1,1],[-10,1.1799,1.6872]],[0,0,0,0],[false,"choc_holder",["RU",10+7,6,0,1,h_unit+2,v_unit+2.5,"RD"],"Q"]],
  [//A
[[0.4087,2.2281],[1,1],[-19,0.9087,2.7281]],[0,0,0,0],[false,"choc_holder",["R",0,6,0,1,h_unit+2,v_unit+4.5,"R"],"A"]],
  [//
[[-0.0001,3.1972],[1,1],[-24.9,0.4999,3.6972]],[0,0,0,0],[false,"choc_holder",["RD",5+7,6,0,1,h_unit+2,v_unit+2.0,"RU"],"Z"]],

  [//W
[[1.7854,0.7199],[1,1],[-5.9,2.2854,1.2199]],[0,0,0,0],[false,"choc_holder",["RU",9+6,7,0.5,1,h_unit+3.5,v_unit+2.0,"D"],"W"]],
  [//S
[[1.6133,1.7688],[1,1],[-13.2,2.1133,2.2688]],[0,0,0,0],[false,"choc_holder",["R",0,7,0.5,1,h_unit+3.5,v_unit+4.9,"C"],"S"]],
  [//X
[[1.292,2.7898],[1,1],[-21.5,1.792,3.2898]],[0,0,0,0],[false,"choc_holder",["RD",5+6,7,0.5,1,h_unit+3.5,v_unit+2.0,"U"],"X"]],

  [//E
[[2.8054,0.5],[1,1],[-4.5,3.3054,1]],[0,0,0,0],[false,switch_type,["RU",8+5,8,1,1,h_unit+4.0,v_unit+2.0,"D"],"E"]],
  [//D
[[2.6967,1.5378],[1,1],[-9.9,3.1967,2.0378]],[0,0,0,0],[false,switch_type,["R",0,8,1,1,h_unit+4.0,v_unit+4.9,"C"],"D"]],
  [//C
[[2.4448,2.5756],[1,1],[-18.1,2.9448,3.0756]],[0,0,0,0],[false,switch_type,["RD",5+5,8,1,1,h_unit+4.0,v_unit+2.0,"U"],"C"]],

  [//R
[[3.7949,0.9304],[1,1],[-5.1,4.2949,1.4304]],[0,0,0,0],[false,"choc_holder",["RU",9+5,9,2,1,h_unit+4.0,v_unit+2.0,"D"],"R"]],
  [//F
[[3.6432,1.9740],[1,1],[-11.5,4.1432,2.474]],[0,0,0,0],[false,"choc_holder",["R",0,9,2,1,h_unit+4.0,v_unit+4.5,"C"],"F"]],
  [//V
[[3.3686,2.9997],[1,1],[-19,3.8686,3.4997]],[0,0,0,0],[false,"choc_holder",["RD",5+5,9,2,1,h_unit+4.0,v_unit+2.0,"U"],"V"]],

  [//T
[[4.7702,1.3325],[1,1],[-6,5.2702,1.8325]],[0,0,0,0],[false,"choc_holder",["RU",10+5,10+5,6,1,h_unit+2,v_unit+2,"LD"],"T"]],
  [//G
[[4.6007,2.3824],[1,1],[-13.5,5.1007,2.8824]],[0,0,0,0],[false,"choc_holder",["R",0,10+5,6,1,h_unit+2,v_unit+4.5,"L"],"G"]],
  [//B
[[4.303,3.4066],[1,1],[-20.6,4.803,3.9066]],[0,0,0,0],[false,"choc_holder",["RD",5+5,10+5,6,1,h_unit+2,v_unit+2,"LU"],"B"]],

  [//Fn1
[[3.5920,4.2937],[1,1],[-21.41,4.092,4.7937]],[0,0,0,0],[false,"choc_holder",["LU",15,15,5,1,h_unit+2,v_unit,"R"],"Fn1"]],
  [//Fn2
[[4.5705,4.7845],[1,1],[-32.31,5.0705,5.2845]],[0,0,0,0],[false,"choc_holder",["LU",10,10,1.5,1,h_unit+6,v_unit,"C"],"Fn2"]],
  [//Fn3
[[5.4303,5.4549],[1,1],[-43.16,5.9303,5.9549]],[0,0,0,0],[false,"choc_holder",["LU",7,7,0,1,h_unit+2,v_unit,"L"],"Fn3"]],
...
[[58-(48.32-5)  +58,-9.96-2,-2],[10.5,1],"Coral","1"],
[[58-104.5    +58,-18.5,-2],[10.5,1],"Coral","2"],
[[58-(117.9-2)  +58,-72.7,-2],[10.5,1],"Coral","3"],
[[58-64.18    +58,-65.28,-2],[10.5,1],"Coral","4"],
[[58-(55.43+2)  +58,-89.51+1,-2],[10.5,1],"Coral","5"],
[[58-0.71     +58,-111.2,-2],[10.5,1],"Coral","6"],
[[58-(-14.92-2) +58,-33.4-1,-2],[10.5,1],"Coral","7"],
[[58-(-2.45+0.5)+58,-48.8+2,-2],[10.5,1],"Coral","8"],
...
*/
[[58--14.5-0.5+58,-71-0.5-17+1.4,-2],[0,0,-90-11+180],[18,27.5,6],"red"],
];
...
*/
[[58--14.5+58-3.18+2 ,-71-18+1.4,-2],[0,0,-90-11+180],"Orange"],
];
...
*/
[[10, -78+1, -1],[0,0,11],1.5,["Designed by Andy Chiu","Bauhaus 93",2],"Blue"],
];
...
/* Write recessed text content on the PCB board / 在PCB板上寫上內凹文字內容
    ...
    =[[x, y, z],[r_x, r_y, r_z],LE_size,[text,font,size],"Show Color"]
*/
[[17, -15-1.5, -0.5],[0,0,11],0.5,["W36 V2","Bauhaus 93",3],"Blue"],
[[20, -15-4.3, -0.5],[0,0,11],0.5,["Curve","Bauhaus 93",3],"Blue"],
];
